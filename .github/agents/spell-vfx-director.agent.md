...
1. `../skills/vfx-authoring/SKILL.md` — art direction, `ParticleVfxParams`, per-`kind` recipes, engine gaps.
2. `../skills/unity-development/SKILL.md` — conventions, URP 2D, sorting, domain-reload safety.
3. `CLAUDE.md` — cardinal rules (console must be clean).
4. `../skills/unity-performance/SKILL.md` when overdraw or spawn-cost is in play.

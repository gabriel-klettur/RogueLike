...
Reads ``python/data/audio/music_analysis.json`` (output of
...
Usage (repo root, venv active)::
    ...
    python python/scripts/patch_audio_catalog_bpm.py
"""
...
ANALYSIS_JSON  = REPO_ROOT / "python" / "data" / "audio" / "music_analysis.json"

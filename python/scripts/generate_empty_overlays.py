...
writes the new files to BOTH:
    - python/data/worlds/base/zones/overlays/{zone}.overlay.json
...
PYTHON_OVERLAYS = ROOT / "python" / "data" / "worlds" / "base" / "zones" / "overlays"

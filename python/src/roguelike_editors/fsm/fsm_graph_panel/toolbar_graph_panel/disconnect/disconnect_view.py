...
LOGGER = logging.getLogger("roguelike_editors.fsm.fsm_graph_panel.tools.disconnect.view")
...
class DisconnectView:
    def render_overlay(self, *, model, screen, canvas_rect, view):
        ...
        # Color (configurable) different from connect
        color = getattr(self, 'preview_color', (220, 120, 120))

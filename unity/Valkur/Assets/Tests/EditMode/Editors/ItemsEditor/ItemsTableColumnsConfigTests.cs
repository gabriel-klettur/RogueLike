...
namespace Valkur.Tests.EditMode.Editors.ItemsEditor
{
    ...
    public class ItemsTableColumnsConfigTests
    {
        ...
        public void OpenColumnsConfigPopup_BuildsLazyPopup_OnFirstClick()
        {
            ...
            TestReflection.Invoke(ed, "OpenColumnsConfigPopup");
        ...
        public void CloseColumnsConfigPopup_HidesPopupWithoutDestroyingIt()
        {
            var ed = CreateActiveEditor();
            TestReflection.Invoke(ed, "OpenColumnsConfigPopup");
            TestReflection.Invoke(ed, "CloseColumnsConfigPopup");
        ...
        public void ToggleColumnOff_HidesColumnFromHeaderAndRows()
        {
            ...
            TestReflection.Invoke(ed, "OnColumnVisibilityToggled", damage, false);
        ...
        public void ToggleColumnOn_RestoresColumn_ToHeaderAndRows()
        {
            ...
            var damage = FindCol("damage");
            TestReflection.Invoke(ed, "OnColumnVisibilityToggled", damage, false);
            TestReflection.Invoke(ed, "OnColumnVisibilityToggled", damage, true);
        ...
        {
            var ed = CreateActiveEditor();
            TestReflection.Invoke(ed, "SetAllColumnsVisible", false);
        ...
        public void SetAllColumnsVisible_True_ShowsEveryColumn()
        {
            ...
            TestReflection.Invoke(ed, "SetAllColumnsVisible", false);
            // … then restore.
            TestReflection.Invoke(ed, "SetAllColumnsVisible", true);
        ...
        public void HiddenColumns_AreCapturedIntoTheWorkspace()
        {
            ...
            TestReflection.Invoke(ed, "OnColumnVisibilityToggled", FindCol("damage"), false);
            TestReflection.Invoke(ed, "OnColumnVisibilityToggled", FindCol("weight"), false);
        ...
        public void Reset_RestoresEveryColumn()
        {
            ...
            TestReflection.Invoke(ed, "OnColumnVisibilityToggled", FindCol("damage"),     false);
            TestReflection.Invoke(ed, "OnColumnVisibilityToggled", FindCol("weight"),     false);
            TestReflection.Invoke(ed, "OnColumnVisibilityToggled", FindCol("critChance"), false);

            TestReflection.Invoke(ed, "ResetColumnsToDefaults");

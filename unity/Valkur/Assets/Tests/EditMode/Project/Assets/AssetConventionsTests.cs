...
namespace Valkur.Tests.EditMode.Project.Assets
{
    ...
    public class AssetConventionsTests
    {
        ...
        private static readonly HashSet<string> ResourcesRootAllowedFolders = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "Skills",      // SkillCatalog, loaded by SkillCatalog.Shared via
                           // Resources.Load("Skills/SkillCatalog"). Same reason as
                           // Chat and Progression: PlayerSkills is AddComponent-ed onto
                           // the player the first time they work a node or craft, and the
                           // skills panel is built procedurally, so neither has an inspector
                           // slot. One index asset — the skills themselves live in
                           // Data/Catalogs/Skills/ and are pulled in by reference.
            "Input",
            "Placeholders",

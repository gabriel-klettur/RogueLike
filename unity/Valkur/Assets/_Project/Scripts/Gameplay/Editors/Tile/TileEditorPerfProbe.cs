...
namespace Valkur.Gameplay.TileEditor
{
    ...
    public partial class TileEditorPerfProbe : MonoBehaviour
    {
        ...
        private void HandleBisectionHotkeys()
        {
            ...
            // drops OS events.
            if (EditorInput.Tool(InputActionCatalog.MapTileEditor, "ProbeExtraCameras")) ToggleExtraCameras();
            if (EditorInput.Tool(InputActionCatalog.MapTileEditor, "ProbeSprites")) ToggleSprites();
            if (EditorInput.Tool(InputActionCatalog.MapTileEditor, "ProbeLights")) ToggleLights();
            if (EditorInput.Tool(InputActionCatalog.MapTileEditor, "ProbeVolumes")) ToggleVolumes();
            if (EditorInput.Tool(InputActionCatalog.MapTileEditor, "ProbePostFx")) TogglePostFx();
            if (EditorInput.Tool(InputActionCatalog.MapTileEditor, "ProbeExtraTilemaps")) ToggleExtraTilemaps();
        }

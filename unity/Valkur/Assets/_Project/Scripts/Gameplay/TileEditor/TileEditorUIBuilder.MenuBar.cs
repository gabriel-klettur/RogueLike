...
namespace Valkur.Gameplay.TileEditor
{
    public static partial class TileEditorUIBuilder
    {
            ...
            System.Action<int> onBrushSizeChanged)
        {
            ...
            MakeBtn(minus, "-", () => onBrushSizeChanged?.Invoke(Mathf.Max(TileEditorConstants.MinBrushSize, state.BrushSize - 1)), 10f);
            ...
            MakeBtn(plus, "+", () => onBrushSizeChanged?.Invoke(Mathf.Min(TileEditorConstants.MaxBrushSize, state.BrushSize + 1)), 10f);
        }
    }
}

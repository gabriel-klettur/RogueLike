...
namespace Valkur.Data
{
    ...
    public static class SpellFieldRelevance
    {
            ...
            new Dictionary<SpellType, HashSet<string>>
        {
            ...
            { SpellType.Dash,       Set("distance", "duration", "collisionDamage", "knockback", "vfxPreset") },
            { SpellType.Teleport,   Set("distance", "vfxPreset") },
            { SpellType.Beam,       Set("damage", "range", "scale", "particleColor", "vfxPreset", "impactPreset") },
            { SpellType.Smoke,      Set("duration", "vfxPreset") },
            { SpellType.SmokeEmitter, Set("duration", "vfxPreset") },
            { SpellType.Wall,       Set("distance", "duration", "particleColor", "sprite",
            ...
            { SpellType.Mine,       Set("damage", "armingTime", "triggerRadius", "explosionRadius",
                                        "explosionDamage", "ttl", "scale", "sprite", "impactPreset") },

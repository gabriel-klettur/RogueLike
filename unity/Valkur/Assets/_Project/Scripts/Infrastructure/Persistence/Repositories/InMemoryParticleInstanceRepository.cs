...
{
    /// <summary>In-memory <see cref="IParticleInstanceRepository"/> for tests.</summary>
    public sealed class InMemoryParticleInstanceRepository : IParticleInstanceRepository
    {

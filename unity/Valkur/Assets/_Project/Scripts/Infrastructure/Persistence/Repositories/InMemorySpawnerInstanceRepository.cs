...
{
    /// <summary>In-memory <see cref="ISpawnerInstanceRepository"/> for tests.</summary>
    public sealed class InMemorySpawnerInstanceRepository : ISpawnerInstanceRepository
    {

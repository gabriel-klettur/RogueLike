...
4. **Verify** — `unityMCP__refresh_unity` (force, scripts) + `unityMCP__read_console`. Hand off to `unity-mcp-guardian` for final cleanup if needed.

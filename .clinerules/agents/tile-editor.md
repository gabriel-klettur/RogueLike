...
5. **Verify** with `unityMCP__refresh_unity` + `unityMCP__read_console`. Hand off to `unity-mcp-guardian` for final cleanup if multiple files were touched.

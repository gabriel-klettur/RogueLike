...
PLAYER_SKILLS = {
    "first_hero": {
        "restore": {"cooldown": 5.0, "duration": 10.0},
        "shield":  {"cooldown": 20.0, "duration": 10.0, "points": 50},
        "firework":{"cooldown": 5.0, "duration": 2.0},
        "smoke":   {"cooldown": 6.0, "duration": 3.0},
        "lightning":{"cooldown": 4.0, "duration": 1.0},
        "pixel_fire":{"cooldown": 3.0, "duration": 2.0}
    }
}

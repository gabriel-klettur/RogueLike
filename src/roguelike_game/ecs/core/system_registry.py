...
def get_update_system_classes():
    ...
    return [
        ...
        MeleeCombatSystem, SpellCastingSystem, AuraSystem, ParticleSystem, LaserBeamEmitterSystem, HealingAuraEmitterSystem, SlashEmitterSystem, FireballSystem, LightningSystem, DashSystem, HitboxSystem,
        TrailSystem,

...
def _calculate_lobby_offset() -> Tuple[int, int]:
    ...
    central de un grid de celdas de ese tamaño.
    """
    ...
    def build_map(
        ...
        *,
        ...
        if map_mode == "global":
            ...
            # 1️⃣ Crear canvas global lleno de muros
            ...
            # 4️⃣ Generar y pegar lobby dinámico en celda central

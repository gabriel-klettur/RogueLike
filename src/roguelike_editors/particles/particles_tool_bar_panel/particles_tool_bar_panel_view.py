"""
Vista para la toolbar de Partículas.
"""
...
class ParticlesToolBarPanelView:
    """Vista de la toolbar de Partículas, posicionada bajo la barra de título."""
    def __init__(self, controller, model):
        ...
        self.widget = ToolbarView(
            ...
            name='ParticlesToolBarPanel',
        )

    def render(self, screen: pygame.Surface):
        # Calcular tamaño total de íconos
        total_h = self.size * len(self.model.tools) + self.padding * (len(self.model.tools) - 1)

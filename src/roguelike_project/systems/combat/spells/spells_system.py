...
# File: src.roguelike_project/systems/combat/view/effects/particles/spells_system.py
import pygame
from pygame.math import Vector2

# MVC: LaserBeam
from src.roguelike_project.systems.combat.spells.laser_beam.model      import LaserBeamModel
from src.roguelike_project.systems.combat.spells.laser_beam.controller import LaserBeamController
from src.roguelike_project.systems.combat.spells.laser_beam.view       import LaserBeamView

# MVC: HealingAura
from src.roguelike_project.systems.combat.spells.healing_aura.model      import HealingAuraModel
from src.roguelike_project.systems.combat.spells.healing_aura.controller import HealingAuraController
from src.roguelike_project.systems.combat.spells.healing_aura.view       import HealingAuraView

# MVC: Smoke
from src.roguelike_project.systems.combat.spells.smoke.model      import SmokeModel
from src.roguelike_project.systems.combat.spells.smoke.controller import SmokeController
from src.roguelike_project.systems.combat.spells.smoke.view       import SmokeView

# MVC: SmokeEmitter
from src.roguelike_project.systems.combat.spells.smoke_emitter.model      import SmokeEmitterModel
from src.roguelike_project.systems.combat.spells.smoke_emitter.controller import SmokeEmitterController
from src.roguelike_project.systems.combat.spells.smoke_emitter.view       import SmokeEmitterView

# MVC: FireworkLaunch
from src.roguelike_project.systems.combat.spells.firework_launch.model      import FireworkLaunchModel
from src.roguelike_project.systems.combat.spells.firework_launch.controller import FireworkLaunchController
from src.roguelike_project.systems.combat.spells.firework_launch.view       import FireworkLaunchView

# MVC: Fireball
from src.roguelike_project.systems.combat.spells.fireball.model      import FireballModel
from src.roguelike_project.systems.combat.spells.fireball.controller import FireballController
from src.roguelike_project.systems.combat.spells.fireball.view       import FireballView

# MVC: Lightning
from src.roguelike_project.systems.combat.spells.lightning.model      import LightningModel
from src.roguelike_project.systems.combat.spells.lightning.controller import LightningController
from src.roguelike_project.systems.combat.spells.lightning.view       import LightningView

# MVC: ArcaneFlame
from src.roguelike_project.systems.combat.spells.arcane_flame.model      import ArcaneFlameModel
from src.roguelike_project.systems.combat.spells.arcane_flame.controller import ArcaneFlameController
from src.roguelike_project.systems.combat.spells.arcane_flame.view       import ArcaneFlameView
...
from src.roguelike_project.systems.combat.spells.sphere_magic_shield.controller import SphereMagicShieldController
from src.roguelike_project.systems.combat.spells.sphere_magic_shield.view       import SphereMagicShieldView

# MVC: Teleport
from src.roguelike_project.systems.combat.spells.teleport.model      import TeleportModel
from src.roguelike_project.systems.combat.spells.teleport.controller import TeleportController
from src.roguelike_project.systems.combat.spells.teleport.view       import TeleportView

# MVC: SlashEffect (legacy)
from src.roguelike_project.systems.combat.spells.slash.model      import SlashModel
from src.roguelike_project.systems.combat.spells.slash.controller import SlashController
from src.roguelike_project.systems.combat.spells.slash.view       import SlashView

# Legacy: DashTrail, DashBounce
from src.roguelike_project.systems.combat.spells.dash.model      import DashModel
from src.roguelike_project.systems.combat.spells.dash.controller import DashController
from src.roguelike_project.systems.combat.spells.dash.view       import DashView
